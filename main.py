...
# Define admin IDs
ADMIN_IDS = [7463601722]  # Add your admin IDs here
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="👨‍💻 Owner", url="https://t.me/CoreUG")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="👑 Owner", url="https://t.me/CoreUG"),
            InlineKeyboardButton(text="⚡ Support", url="https://t.me/CoreXExtractor"),
        ],
        [
        ...
        [
            InlineKeyboardButton(text="📢 Channel", url="https://t.me/UGxBots"),
        ],
    ]
)
...
async def help_button(client, callback_query):
    ...
    f"╭────────⊰◆⊱────────╮\n"
    f" ➠ ᴍᴀᴅᴇ ʙʏ: [🂾 Mʀ ㄩᎶ ʙᴏᴛꜱ](https://t.me/CoreUG) 💻\n"
    f"╰────────⊰◆⊱────────╯\n"
)
...
async def features_button(client, callback_query):
    ...
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n\n"
    f"╭────────⊰◆⊱────────╮\n"
    f" ➠ M𝗮𝗱𝗲 B𝗼𝘁𝘀 : [🂾 Mʀ ㄩᎶ 𝗯𝗼𝘁𝘀](https://t.me/CoreUG) 💻\n"
    f"╰────────⊰◆⊱────────╯"
)
...
async def start_command(bot: Client, message: Message):
    ...
    f"⚡ **ᴘᴏᴡᴇʀᴇᴅ ʙʏ** [@CoreUG](https://t.me/CoreUG)"
)
...
async def txt_handler(client: Client, m: Message):
    ...
    f"• **ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜꜱᴇʀꜱ ᴏɴʟʏ**\n\n"  
    f"╭────────⊰◆⊱────────╮\n"   
    f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [🂾 Mʀ ㄩᎶ 𝗕𝗢𝗧𝗦](https://t.me/CoreUG) 💻\n"
    f"╰────────⊰◆⊱────────╯\n"
    )
    )
         ...
         f'**🌟 𝐸𝑥𝑡𝑟𝑎𝑐𝑡𝑒𝑑 𝐵𝑦 :** {CR}'
                ...
                if "drive" in url:
                    ...
                    Show = f"╭━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           ...
                           f"╰━━━━━ ✦ 𝐵𝑜𝓉 𝓂𝒶𝒹𝑒 𝒷𝓎 ✦ [🂾 Mʀ ㄩᎶ 𝗯𝗼𝘁𝘀](https://t.me/CoreUG)"
